...
v_0 = [-0.1;0]; % initial condition q(-1) -> v(0) = 0
q_m = q_0 - T*v_0;
...
% Forward simulation
    for k = 1:int64(T_end/T)
        ...
        E(k) = 0.5*v'*M *v -(L(1)*r(1)*m(1)*g*cos(q(2*k-1))+V;
    end
end
...
function f = varint2(x, q_, q_0, u_plus, u_minus, T_) 
    ...
    q0x = q_(1);
    q0y = q_(2);
    dm = [(((10*cos(q0y/2 + q1y/2) + 688/45)*(conj(q0x) - conj(q1x)))/(2*conj(T_)) + ((5*cos(q0y/2 + q1y/2) + 463/90)*(conj(q0y) - conj(q1y)))/(2*conj(T_)))/T_ + ((10*cos(q0y/2 + q1y/2) + 688/45)*(q0x - q1x))/(2*T_*conj(T_)) + ((5*cos(q0y/2 + q1y/2) + 463/90)*(q0y - q1y))/(2*T_*conj(T_)), ((463*(conj(q0y) - conj(q1y)))/(180*conj(T_)) + ((5*cos(q0y/2 + q1y/2) + 463/90)*(conj(q0x) - conj(q1x)))/(2*conj(T_)))/T_ - ((q0x - q1x)*((5*sin(q0y/2 + q1y/2)*(conj(q0x) - conj(q1x)))/(2*conj(T_)) - (5*cos(q0y/2 + q1y/2) + 463/90)/(2*conj(T_)) + (5*sin(q0y/2 + q1y/2)*(conj(q0y) - conj(q1y)))/(4*conj(T_))))/T_ + ((463/(180*conj(T_)) - (5*sin(q0y/2 + q1y/2)*(conj(q0x) - conj(q1x)))/(4*conj(T_)))*(q0y - q1y))/T_];
    q1x = q_(1);
    q1y = q_(2);
    q0x = q_0(1);
    q0y = q_0(2);
    dp =[- (((10*cos(q0y/2 + q1y/2) + 688/45)*(conj(q0x) - conj(q1x)))/(2*conj(T_)) + ((5*cos(q0y/2 + q1y/2) + 463/90)*(conj(q0y) - conj(q1y)))/(2*conj(T_)))/T_ - ((10*cos(q0y/2 + q1y/2) + 688/45)*(q0x - q1x))/(2*T_*conj(T_)) - ((5*cos(q0y/2 + q1y/2) + 463/90)*(q0y - q1y))/(2*T_*conj(T_)), - ((463*(conj(q0y) - conj(q1y)))/(180*conj(T_)) + ((5*cos(q0y/2 + q1y/2) + 463/90)*(conj(q0x) - conj(q1x)))/(2*conj(T_)))/T_ - ((q0x - q1x)*((5*cos(q0y/2 + q1y/2) + 463/90)/(2*conj(T_)) + (5*sin(q0y/2 + q1y/2)*(conj(q0x) - conj(q1x)))/(2*conj(T_)) + (5*sin(q0y/2 + q1y/2)*(conj(q0y) - conj(q1y)))/(4*conj(T_))))/T_ - ((463/(180*conj(T_)) + (5*sin(q0y/2 + q1y/2)*(conj(q0x) - conj(q1x)))/(4*conj(T_)))*(q0y - q1y))/T_];
